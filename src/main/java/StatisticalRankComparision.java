...
class StatisticalRankComparision {
    static List<Double> compareAllCases(List<List<UtilityGeneral.Pair>> listOfOrderedListsOne,
                                        List<List<UtilityGeneral.Pair>> listOfOrderedListsTwo, double p) throws Exception {
    ...
    private static double compareRankedLists(List<UtilityGeneral.Pair> orderedListOne, List<UtilityGeneral.Pair> orderedListTwo, double p){
