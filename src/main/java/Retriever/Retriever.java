...
public class Retriever {
    public static JsonObject searchResultRetriever(ParameterCreator params) throws IOException {
    ...
    private static HttpURLConnection sendPostRequest(ParameterCreator params) throws IOException {
